...
object MMFontUtils {
    ...
    fun Uni2XP(str: String): String {
        ...
        /* uni10391000 */str = str.replace("\u1039\u1000", "ၠ")
        /* uni10391001 */str = str.replace("\u1039\u1001", "ၡ")
        /* uni10391002 */str = str.replace("\u1039\u1002", "ၢ")
        /* uni10391003 */str = str.replace("\u1039\u1003", "ၣ")
        /* uni10391005 */str = str.replace("\u1039\u1005", "ၨ")
        /* uni10391006 */str = str.replace("\u1039\u1006", "ၩ")
        /* uni10391007 */str = str.replace("\u1039\u1007", "ၪ")
        /* uni10391008 */str = str.replace("\u1039\u1008", "ၫ")
        /* uni1039100F */str = str.replace("\u1039\u100F", "ၴ")
        /* uni10391010 */str = str.replace("\u1039\u1010", "ၵ")
        /* uni10391011 */str = str.replace("\u1039\u1011", "ၷ")
        /* uni10391012 */str = str.replace("\u1039\u1012", "ၸ")
        /* uni10391013 */str = str.replace("\u1039\u1013", "ၹ")
        /* uni10391014 */str = str.replace("\u1039\u1014", "ၺ")
        /* uni10391015 */str = str.replace("\u1039\u1015", "ၻ")
        /* uni10391016 */str = str.replace("\u1039\u1016", "ၼ")
        /* uni10391017 */str = str.replace("\u1039\u1017", "ၽ")
        /* uni10391018 */str = str.replace("\u1039\u1018", "ၾ")
        /* uni10391019 */str = str.replace("\u1039\u1019", "ၿ")
        /* uni103B103D */str = str.replace("\u103B\u103D", "ႁ")
        /* uni103C103D */str = str.replace("\u103C\u103D", "ႅxႍ")
        /* uni103B103E */str = str.replace("\u103B\u103E", "ႂ")
        /* uni103C103E */str = str.replace("\u103C\u103E", "ႅx႑")
        /* uni103B103D103E */str = str.replace("\u103B\u103D\u103E", "ႃ")
        /* uni103C103D103E */str = str.replace("\u103C\u103D\u103E", "ႅxႎ")
        str = str.replace("\u103d\u103e", "ႎ")
        /* uni103E1030 */
        //ERROR str = str.replace("\u103E\u1030","");
        //specials
        /* uni100C1039100C */str = str.replace("\u100C\u1039\u100C", "ၘ")
        /* uni100B1039100C */
        //ERROR str = str.replace("\u100B\u1039\u100C","");
        /* uni100F1039100D */str = str.replace("\u100F\u1039\u100D", "ဏ​ၱ")
        /* uni100F1039100B */str = str.replace("\u100F\u1039\u100B", "ဏ​ၮ")
        /* uni100F1039100C */str = str.replace("\u100F\u1039\u100C", "ဏ​ၰ")
        /* uni100F1039100F */str = str.replace("\u100F\u1039\u100F", "ဏၴ​")
        /* uni100F1039100E */str = str.replace("\u100F\u1039\u100E", "ဏ​ၳ")
        /* uni100D1039100E */str = str.replace("\u100D\u1039\u100E", "ဎ​ၲ")
        /* uni100D1039100D */str = str.replace("\u100D\u1039\u100D", "ဍ​ၮ")
        /* uni100B1039100B */str = str.replace("\u100B\u1039\u100B", "ဋ​ၮ")
        /* uni100710391009 */str = str.replace("\u1007\u1039\u1009", "ဥ​ၼ")
        /* uni10391009 */str = str.replace("\u1039\u1009", "")
        /* uni1039100B */str = str.replace("\u1039\u100B", "ၮ")
        /* uni1039100Bvar */
        //ERROR str = str.replace("\u1039\u100B","");
        /* uni1039100C */str = str.replace("\u1039\u100C", "ၰ")
        /* uni1039100D */str = str.replace("\u1039\u100D", "ၱ")
        /* uni1039100E */str = str.replace("\u1039\u103E", "ၳ")
        /* uni1039100F */str = str.replace("\u1039\u100F", "ၴ")
        ...
        for (i in 0 until str.length) {
            ...
            if (state == 1 && c.toInt() == 0x102f) c = 'ဳ'
            if (state == 1 && c.toInt() == 0x1030) c = 'ဴ'
            sb.append(c)
        }
        str = sb.toString()
        val ukm = charArrayOf('ႀ', 'ႍ', '႐', 'ု', 'ူ', 'န', 'ႅ')
        //UKM
        sb = StringBuilder()
        state = 0
        var move = false
        ...
        for (i in 0 until str.length) {
            ...
            if (c == 'ႄ' || c.toInt() == 0x103c) shorten = true
            if (c == 'န') {
                if (shorten) {
                    c = 'ၙ'
                } else {
